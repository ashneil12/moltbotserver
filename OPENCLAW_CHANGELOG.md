...
| ----------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------- |
| `docker-entrypoint.sh`                          | Wrapped ByteRover init block in subshell with `unset PORT` to prevent `brv-server` from hijacking the gateway port                                                                                                                                                                                                       | None — custom   |
| `src/config/paths.ts`                           | `resolveGatewayPort()` now accepts `PORT` as low-priority fallback after `OPENCLAW_GATEWAY_PORT` and `CLAWDBOT_GATEWAY_PORT`                                                                                                                                                                                             | Medium          |
| `src/infra/ports-inspect.ts`                    | **NEW** `parseProcNetTcpListeners()` — exported pure function for testable `/proc/net/tcp` parsing. `readLinuxProcNetTcpListeners` integrated as fallback when `lsof`/`ss` unavailable. **Bug fix:** filters for TCP LISTEN state `0A` only (was matching all states). Converted sync I/O to async `fsPromises.readFile` | Low — additive  |
| `docs/gateway/configuration.md`                 | Added "Gateway Port" section recommending `OPENCLAW_GATEWAY_PORT` over generic `PORT`                                                                                                                                                                                                                                    | None — docs     |
| `src/config/paths.test.ts`                      | +8 tests: PORT fallback priority, invalid/zero/negative PORT, whitespace trimming                                                                                                                                                                                                                                        | None — test     |
| `src/infra/ports-inspect.test.ts`               | +7 tests: LISTEN state matching, ESTABLISHED/TIME_WAIT exclusion, hex port conversion, empty content, remote address non-match                                                                                                                                                                                           | None — test     |
| `IDENTITY.md`                                   | Enhanced "Have opinions" + added communication imperative cross-ref to `howtobehuman.md`                                                                                                                                                                                                                                 | None — template |
| `docs/reference/templates/IDENTITY.md`          | Same as above (template version)                                                                                                                                                                                                                                                                                         | None — template |
| `docs/reference/templates/howtobehuman.md`      | Cross-reference to `THE_ART_OF_BEING_FUNNY.md`                                                                                                                                                                                                                                                                           | None — template |
| `docs/reference/templates/openclaw-human-v1.md` | Cross-reference to `THE_ART_OF_BEING_FUNNY.md`                                                                                                                                                                                                                                                                           | None — template |

> **Sync Risk:** `paths.ts` — `resolveGatewayPort` adds `env.PORT` to the fallback chain. If upstream modifies this function, re-apply. `ports-inspect.ts` — new exported function + async I/O wrapper, additive.
