...
<<<<<<< HEAD:src/web/auto-reply.web-auto-reply.reconnects-after-connection-close.test.ts
...
>>>>>>> 292150259 (fix: commit missing refreshConfigFromDisk type for CI build):src/web/auto-reply.web-auto-reply.reconnects-after-connection-close.e2e.test.ts
  return {
    log: vi.fn(),
    error: vi.fn(),
    exit: vi.fn(),
